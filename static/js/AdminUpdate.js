...
export default function AdminUpdate({ onDataFromChild }) {
          ...
          <div className="ml-10">
            <div>
              ...
              <div className="mt-3 flex justify-center mb-2">
                <input type="radio" checked name="gender" className="h-5 w-5 cursor-pointer" />{" "}
            ...
            <div className="mb-2">
              ...
              <p className="font-bold text-lg">ChrisW</p>
